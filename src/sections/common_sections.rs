...
pub fn add_common_sections<T, I>(site: &mut Site<T, I>) {
        ...
        <section class="about-our-clinics">
            <div class="inner">
                <div class="image-area">
                    ...
                    <a class="view-locations-button" href="#locations"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" focusable="false" color="var(--token-bbd03ddf-1640-40ca-ba74-d0deb83f7d14, rgb(104, 248, 253))" style="user-select: none; width: 100%; height: 100%; display: inline-block; fill: var(--token-bbd03ddf-1640-40ca-ba74-d0deb83f7d14, rgb(104, 248, 253)); color: var(--token-bbd03ddf-1640-40ca-ba74-d0deb83f7d14, rgb(104, 248, 253)); flex-shrink: 0;"><g color="var(--token-bbd03ddf-1640-40ca-ba74-d0deb83f7d14, rgb(104, 248, 253))" weight="light"><path d="M128,66a38,38,0,1,0,38,38A38,38,0,0,0,128,66Zm0,64a26,26,0,1,1,26-26A26,26,0,0,1,128,130Zm0-112a86.1,86.1,0,0,0-86,86c0,30.91,14.34,63.74,41.47,94.94a252.32,252.32,0,0,0,41.09,38,6,6,0,0,0,6.88,0,252.32,252.32,0,0,0,41.09-38c27.13-31.2,41.47-64,41.47-94.94A86.1,86.1,0,0,0,128,18Zm0,206.51C113,212.93,54,163.62,54,104a74,74,0,0,1,148,0C202,163.62,143,212.93,128,224.51Z"></path></g></svg>
    ...
    site.declare_css("dentist_splash_hero", r##"
    ...
    site.declare_section("locations",&format!(r##"
    ...
    site.declare_section("services",&format!(r##"
    ...
    site.declare_css("general_services", r##"
    ...
    site.declare_section("open_times",&format!(r##"
